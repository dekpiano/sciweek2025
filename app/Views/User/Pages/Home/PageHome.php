...
.sale-button-sticker {
    ...
    padding: 15px 30px;
    border-radius: 50% / 10%;
    /* ทำให้เป็นรูปวงรี หรือปรับให้กลมขึ้น */
...
.sale-button-sticker:hover {
    transform: translateY(-4px) rotate(2deg);
    /* ยกขึ้นเล็กน้อยและหมุนเมื่อโฮเวอร์ */
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 text-center text-center">
                ...
                <h2 class="text-white text-center pb-3 animated zoomIn" style="text-shadow: 2px -4px 6px #020202;">
                    งานมหกรรมวันวิทยาศาสตร์ <br> “วิทย์ยุคใหม่ AI
                ...
                <div class="mt-4 animated slideInRight">                  

                    <!-- ปุ่มที่ 2: "Sticker" Look Button -->
                    <div class="button-wrapper ">
                        <button class="sale-button-sticker" onclick="window.open('https://drive.google.com/drive/folders/1TtJ89By-BEqGD0-lmHcn2gO93UjQGuRH', '_blank')">
                            ประกาศรายชื่อทีมมีสิทธิ์เข้าแข่งขัน!
                        </button>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchAndDisplayTeams(competitionKey) {
        ...
        if (!webAppUrl || !webAppUrl.startsWith('https://script.google.com/macros/s/')) {
            modalTeamList.innerHTML =
                `<p class="text-danger text-center py-4">ข้อผิดพลาด: ไม่พบ URL ของ Google Apps Script Web App ที่ถูกต้องสำหรับประเภทการแข่งขันนี้</p>`;
            console.error(
