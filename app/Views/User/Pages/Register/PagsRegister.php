...
.invalid-feedback {
    display: block;
    /* Ensure feedback is always visible when needed by JS */
    margin-top: 0.25rem;
...
.form-floating>label {
    ...
    /* Adjust label padding if needed */
}
</style>
<?= $this->endSection() ?>
...
<div class="bg-primary page-header">
    <div class="container text-center">
        <h1 class="text-white animated zoomIn mb-3">แบบฟอร์มสมัครเข้าร่วมแข่งขัน<?=$KeyName;?></h1>
        <p class="text-white animated zoomIn mb-4">กรุณากรอกข้อมูลให้ครบถ้วนและถูกต้อง</p>
    </div>
</div>
        ...
        <fieldset class="mb-4 p-3 border rounded-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="competitionType" name="competitionType" required>
                    ...
                    <option value="<?= $value->ctype_keyname?>">
                        <?='การแข่งขัน'.$value->ctype_name.' '.$value->ctype_level; ?></option>
                    <?php endforeach;?>
    ...
    function addTeamMemberField(isInitialSetup = false) {
        ...
        memberDiv.innerHTML = `
                    ...
                    <div class="row g-2">
                        <div class="col-md-2">
                            <div class="form-floating mb-3">
                                <select class="form-select" id="memberPrefix${memberCount}" name="teamMembers[${memberCount}][prefix]" required>
                                    <option value="">เลือก</option>
                                    <option value="นาย">นาย</option>
                                    <option value="นางสาว">นางสาว</option>
                                    <option value="เด็กชาย">เด็กชาย</option>
                                ...
                                <label for="memberPrefix${memberCount}">คำนำหน้า:</label>
                            </div>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-md-5">
